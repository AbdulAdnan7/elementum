...
const Footer = () => {
  return (
    <footer className="mt-8 md:mt-24 lg:mt-62 w-full bg-[#D7EEDD]">
      {/* Top arrows */}
      <div className="hidden md:flex justify-center gap-2 p-2 animate-pulse">
      ...
      <div className="text-center px-4 py-4 md:px-0">
        ...
        <div className="relative">
          <h1 className="font-sans text-3xl md:text-6xl opacity-100 translate-y-4 transition-all duration-700 delay-100 hover:opacity-100 hover:translate-y-0">
          ...
          <button className="bg-black px-4 py-2 md:px-8 md:py-4 rounded-full mt-4 text-white transition-all duration-500 hover:bg-gray-800 hover:scale-105">
            Subscribe now
          </button>
        </div>
        {/** FOr Image */}
